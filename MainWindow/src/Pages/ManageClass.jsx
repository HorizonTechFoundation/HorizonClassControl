...
import ManageClassImg from "../assets/ManageClassImg.png"
...
function ManageClass(){
    ...
    return(
        ...
        <section className='manageclass-cont'>
            <div className='manageclass-top'>
                <p>Manage All Classes</p>
            </div>

            <div className='manageclass-main'>
                <div className='manageclass-main-cont'>
                    <div className='manageclass-main-left'>
                        <table
                            className='manageclass-main-left-table'
                            cellPadding="10"
                        >
                            <thead>
                            <tr>
                    ...
                    <div className='manageclass-main-right'>

                        <div className='manageclass-main-right-img'>
                            <img src={ManageClassImg}/>
                        </div>
                        <div className='manageclass-main-right-cont'>
                            <p className='manageclass-main-right-cont-l1'>Environmental And Social Impact Assessment</p>
                            <p className='manageclass-main-right-cont-l2'>Erana Veerapa Dinesh</p>
                            <p className='manageclass-main-right-cont-l3'>10:30 AM - 11:20 AM At B2L03</p>
                        </div>
                        
                        <div className='manageclass-main-right-but'>
                            <button onClick={() => navigate('/editclass')}>Edit Class</button>
                            <button onClick={() => navigate('/classroom')}>Start Class</button>
                        </div>
